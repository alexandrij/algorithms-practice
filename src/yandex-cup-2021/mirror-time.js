...
function mirrorTime(hours, minutes) {
  if (hours < 0 || hours > 11) {
    throw new Error(
      'The "hours" parameter must be greater than or equal to 0 and less than or equal to 11',
    );
  }
  if (minutes < 0 || minutes > 59) {
    throw new Error(
      'The "minutes" parameter must be greater than or equal to 0 and less than or equal to 59',
    );
  }
